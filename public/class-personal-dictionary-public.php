...
class Personal_Dictionary_Public {
	...
	public function enqueue_scripts() {
        ...
        wp_localize_script( $this->plugin_name, 'aysPersonalDictionaryAjaxPublic', array(
			...
			'icons' => array(
				'close_icon' 	=> '<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-5-9h10v2H7z"/></svg>',
	...
	public function show_pd(){
		...
		$content[] = '<div class="' . $this->html_class_prefix . 'nav-menu ' . '">';
			$content[] = '<a href="' . $group_tab_url . '"  class="' . $this->html_class_prefix . 'nav-tab' . '">'. $texts[ 'groups' ] .'</a>';
			$content[] = '<a href="' . $games_tab_url . '"  class="' . $this->html_class_prefix . 'nav-tab' . '">'. $texts[ 'games' ] .'</a>';
		$content[] = '</div>';
