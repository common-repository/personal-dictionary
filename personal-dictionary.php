 ...
 */
define( 'PERSONAL_DICTIONARY_VERSION', '1.0.0' );
            ...
            <div class="navigation-bar">
                <div id="navigation-container">
                    ...
                    <ul id="menu">
                        ...
                        <li><a class="ays-btn" href="https://poll-plugin.com/wordpress-personal-dictionary-plugin-free-demo/" target="_blank">Demo</a></li>
